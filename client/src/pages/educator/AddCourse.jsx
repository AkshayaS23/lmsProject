...
const AddCourse = () => {
  ...
  return (
    <div className='h-screen overflow-scroll flex flex-col items-start justift-between md:p-8 md:pb-0 p-4 pt-8 pb-0'>
                  ...
                  <div className='p-4'>
                    {chapter.chapterContent.map((lecture, lectureIndex) => (
                      <div key={lectureIndex} className='flex justify-between items-center mb-2'>
                        ...
                        onClick={()=> handleLecture ('add', chapter.chapterId, lectureIndex)}
